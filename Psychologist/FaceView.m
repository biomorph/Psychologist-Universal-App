...
#define MOUTH_SMILE 0.25
    ...
    mouthEnd.x = mouthEnd.x + 2 * MOUTH_H * size;
    CGPoint mouthCP1 = mouthStart;
    mouthCP1.x = mouthCP1.x + MOUTH_H * size * 2/3;
    CGPoint mouthCP2 = mouthEnd;
    mouthCP2.x = mouthCP2.x - MOUTH_H * size * 2/3;
    
    float smile = [self.dataSource smileForFaceView:self];//This should be delegated, it is our view's data
    if (smile>1) {
        smile = 1;
    }
    if (smile<-1) {
